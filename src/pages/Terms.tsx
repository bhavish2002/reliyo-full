...
const sections = [
  ...
  { title: "4. Acceptable Use", content: "You agree not to use Reliyo for any unlawful purpose, to post misleading or fraudulent tasks, to harass or abuse other users, to attempt to circumvent the platform's payment or settlement rules, or to use automated tools to scrape or manipulate the platform." },
  { title: "5. Payments and platform-held funds", content: "Task payments are held as platform-held funds until completion milestones and approvals defined in our policies. Platform fees and refunds follow the published settlement rules and dispute process." },
