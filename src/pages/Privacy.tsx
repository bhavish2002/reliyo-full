...
const sections = [
  ...
  { title: "4. Data Protection", content: "We implement industry-standard security measures to protect your personal data, including encryption of data in transit and at rest, secure escrow payment processing, regular security audits and vulnerability assessments, and access controls limiting data access to authorized personnel only." },
  { title: "5. Third-Party Sharing", content: "Reliyo does not sell your personal data. We may share information with payment processors to facilitate escrow transactions, legal authorities when required by law, service providers who assist in platform operations (under strict confidentiality agreements), and other users only to the extent necessary for task completion (e.g., displaying your name and trust score)." },
